...
const ResetPassword = () => {
  ...
  const checkPasswordStrength = (password) => {
    ...
    const hasLetter = /[a-zA-Z]/.test(password);
    const hasNumber = /[0-9]/.test(password);
    if (password.length >= 8 && hasLetter && hasNumber) return "strong";
        ...
        <div className="glass-container">
          ...
          <form onSubmit={handleSubmit} className="reset-form-box">
            ...
            <div className="password-wrapper">
              ...
              {errors.password && (
                <small style={{ color: "red", display: "block" }}>{errors.password}</small>
              )}
            </div>
            ...
            <div className="password-wrapper">
              ...
              />
              <i
                className={`bi ${showConfirmPassword ? "bi-eye" : "bi-eye-slash"} password-icon`}
